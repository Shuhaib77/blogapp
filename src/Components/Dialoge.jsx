    ...
    <div>
      ...
      <Dialog open={size === "md"} size={size || "md"} handler={handleOpen}>
        ...
        <DialogBody>
            ...
            <div className="mb-5">
                <Input label="post" type="file" onChange={handleimage} onBlur={handleBlur}  name="post"></Input>
            </div>
            <div>
                <Textarea label="Message" onChange={handleChange} onBlur={handleBlur} value={values.description} name="description"></Textarea>
            </div>
